...
<header class="site-header">
	<div class="container site-header__inner">
		...
		{:else}
			<nav class="navbar">
				<Button href={resolve('/login')} icon={signUpIcon} letter="S">Sign Up</Button>
			</nav>
		{/if}
	</div>
</header>
